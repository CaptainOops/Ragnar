...
> **[CREDITS.md](docs/CREDITS.md)** — Solarflere identified and curated the CVE corpus behind Ragnar's passive detection suite — **208 CVEs detected** from the wire, 247 named (CVE-2002-1623 → CVE-2026-81736). See the full writeup and numbers there, and the **[CVE Index](docs/CVE.md)** for every CVE with its detector and status.
